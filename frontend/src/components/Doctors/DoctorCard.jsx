...
const DoctorCard = ({ doctor }) => {
  ...
  return (
    <div className="p-3 lg:p-5">
      <div>
        <img src={photo} className="w-full" alt="photos" />
      </div>
      <h2 className="text-[18px] leading-[30px] lg:text-[20px] lg:leading-9 text-headingColor font-[700] mt-3 lg:mt-5">
        {name}
      </h2>
      <div className="mt-2 lg:mt-4 flex items-start justify-between">
      ...
      <div className="mt-[18px] lg:mt-5 flex items-center justify-between">
        <div>
          {/*<h3
            className="text-[16px] leading-7 lg:text-[18px] lg:leading-[30px] font-semibo
              text-headingColor"
          >
            +{totalPatients}
            patients
