        ...
        <div className="flex justify-center gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
            ...
            <p className="text__para">
              For 30 years in a row Indian media & World Report has recognized
              us as one of the best public hospital in the Nation and #1 in
              texas. Lorem ipsum dolor sit amet consectetur, adipiscing elit.
              quas, nemo?
            </p>
            ...
            <p className="text__para mt-[30px]">
              ...
              what we can do tomorrow. Provinding the best.Lorem ipsum dolor sit
