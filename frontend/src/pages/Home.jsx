...
import { BsArrowRight, BsImageAlt } from "react-icons/bs";
  ...
  return (
    <>
          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            md:leading-[70px]"
                ...
                <p className="text__para">
                  ...
                  Minus facilis voluptates commodi vel! Repudiandae hic quaerat
                  tempora eum quos cumque a magnam harum doloribus vitae
                  debitis, in, illo ea facere!
                </p>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text_para">Clinic loaction</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text_para">Satisified patients</p>
                </div>
              </div>
            </div>
            {/*==== hero content ==== */}
        ...
        <div className="container">
          <div className="lg:w-[470px] mx-auto">
            ...
            <p className="text__para text-center">
              World-class Health care with unmatched expert health care
            </p>
          </div>
          <div
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="xl:w[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="text__para">
                  3.View our phyisicans who are accepting new patients , use the
                  outline scheduling tool to select an appointment time.
                </li>
              </ul>
              <Link to="/">
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              >
                ...
                <div
                  className="w-[65px] lg:w-[96px] bg-[#CCF03] py-1 px-2 lg:py-[6px] lg:px-[10px] text-
      ...
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            <h2 className="heading text-center"> The doctors</h2>
            <p className="text__para text-center">
              World class care for everyone. Our health System offers unmatched,
              expert health care.
            </p>
